...
3. [Разработка модели для оценки стоимости IT-специалиста](#salary_predict)
    ...
    3.2. [Кластеризация skills на каноны Сlovery (компания - организатор). Проверка через LLM.](#stage_2_claster)
    ...
    3.14. [Повторная обработка с mapped_skills . Вторичный EDA. Кластеризация вакансий вокруг навыков. ML проверка результатов](#stage_5_eda_ml)
...
#### <a id ='stage_2_claster'> 3.2 Кластеризация skills на каноны Сlovery (компания - организатор). Проверка через LLM.
...
#### <a id ='stage_5_eda_ml'> 3.14 Повторная обработка с mapped_skills . Вторичный EDA. Кластеризация вакансий вокруг навыков. ML проверка результатов.
...
- Сократили размерности по skills c 42 000 уникальных навыков до ~ 2000 , а разнообразие вакансий с 8000 до ~3000 
